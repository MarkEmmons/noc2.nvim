...
if vim.g.noc2_italic_keywords then
  italic_keywords = true
end

if vim.g.noc2_italic_functions then
  italic_functions = true
end

if vim.g.noc2_italic_comments then
  italic_comments = true
end

if vim.g.noc2_italic_loops then
  italic_loops = true
end

if vim.g.noc2_italic_conditionals then
...
theme.set_highlights = function()
  ...
  hl(0, "MsgArea", { fg = c.fg, bg = c.bg })
	...
	-- Dap Signs
	hl(0, "DapSignBreakpoint", { fg = c.red, bg = "NONE" })

	-- Neotest
	hl(0, "NeotestAdapterName", { fg = c.fg, bg = "NONE" })
	hl(0, "NeotestBorder", { fg = c.light_white, bg = "NONE" })
	hl(0, "NeotestDir", { fg = c.light_blue, bg = "NONE" })
	hl(0, "NeotestExpandMarker", { fg = c.yellow, bg = "NONE" })
	hl(0, "NeotestFailed", { fg = c.red, bg = "NONE" })
	hl(0, "NeotestFile", { fg = c.yellow, bg = "NONE" })
	hl(0, "NeotestFocused", { fg = c.red, bg = "NONE" })
	hl(0, "NeotestIndent", { fg = c.red, bg = "NONE" })
	hl(0, "NeotestMarked", { fg = c.light_white, bg = "NONE", italic = true })
	hl(0, "NeotestNamespace", { fg = c.red, bg = "NONE" })
	hl(0, "NeotestPassed", { fg = c.red, bg = "NONE" })
	hl(0, "NeotestRunning", { fg = c.red, bg = "NONE" })
	hl(0, "NeotestWinSelect", { fg = c.red, bg = "NONE" })
	hl(0, "NeotestSkipped", { fg = c.yellow, bg = "NONE" })
	hl(0, "NeotestTarget", { fg = c.red, bg = "NONE" })
	hl(0, "NeotestTest", { fg = c.red, bg = "NONE" })
	hl(0, "NeotestUnknown", { fg = c.red, bg = "NONE" })
  ...
  hl(0, "SpellRare", { fg = "NONE", bg = "NONE", sp = c.light_cyan, underline = true })
  hl(0, "NormalNC", { fg = c.fg, bg = c.bg })
  hl(0, "Pmenu", { fg = c.light_white, bg = c.alt_bg })
  ...
  hl(0, "MatchWord", { fg = c.bg, bg = c.fg })
  hl(0, "MatchParen", { fg = c.gray, bg = c.green })
  hl(0, "MatchWordCur", { fg = c.bg, bg = c.fg })
  hl(0, "MatchParenCur", { fg = c.bg, bg = c.fg })
  ...
  hl(0, "Directory", { fg = c.light_red, bg = "NONE" })
  ...
  hl(0, "String", { fg = c.light_cyan, bg = "NONE" })
  hl(0, "Character", { fg = c.green, bg = "NONE" })
  hl(0, "Number", { fg = c.light_magenta, bg = "NONE" })
  hl(0, "Float", { fg = c.light_magenta, bg = "NONE" })
  hl(0, "Boolean", { fg = c.light_magenta, bg = "NONE" })
  hl(0, "Constant", { fg = c.light_magenta, bg = "NONE" })
  ...
  hl(0, "Todo", { fg = c.light_white, bg = "NONE", bold = true })
  ...
  hl(0, "NvimTreeOpenedFolderName", { fg = c.light_blue, bg = "NONE", bold = true, italic = true })
  hl(0, "NvimTreeEmptyFolderName", { fg = c.gray, bg = "NONE", italic = true })
  hl(0, "NvimTreeGitIgnored", { fg = c.gray, bg = "NONE", italic = true })
  hl(0, "NvimTreeImageFile", { fg = c.gray, bg = "NONE" })
  ...
  hl(0, "BookmarkLine", { fg = c.blue, bg = "NONE" })
  hl(0, "BookmarkAnnotationLine", { fg = c.blue, bg = "NONE" })

  -- Bqf
  hl(0, "BqfPreviewBorder", { fg = c.fg, bg = "NONE" })
  hl(0, "BqfPreviewRange", { fg = "NONE", bg = c.blue })
  ...
  hl(0, "GpsItemKindFunction", { fg = c.purple, bg = "NONE" })
  hl(0, "GpsItemKindMethod", { fg = c.purple, bg = "NONE" })
  hl(0, "GpsItemKindConstructor", { fg = c.orange, bg = "NONE" })
  hl(0, "GpsItemKindClass", { fg = c.orange, bg = "NONE" })
  hl(0, "GpsItemKindEnum", { fg = c.orange, bg = "NONE" })
  hl(0, "GpsItemKindEvent", { fg = c.purple, bg = "NONE" })
  hl(0, "GpsItemKindInterface", { fg = c.fg, bg = "NONE" })
  hl(0, "GpsItemKindStruct", { fg = c.blue, bg = "NONE" })
  hl(0, "GpsItemKindVariable", { fg = c.blue, bg = "NONE" })
  hl(0, "GpsItemKindField", { fg = c.blue, bg = "NONE" })
  hl(0, "GpsItemKindProperty", { fg = c.blue, bg = "NONE" })
  hl(0, "GpsItemKindEnumMember", { fg = c.fg, bg = "NONE" })
  hl(0, "GpsItemKindConstant", { fg = c.blue, bg = "NONE" })
  ...
  hl(0, "packerSuccess", { fg = c.success, bg = "NONE" })
  ...
  -- Language
  hl(0, "xmlTag", { fg = c.light_red, bg = "NONE" })
  ...
  hl(0, "htmlArg", { fg = c.light_green, bg = "NONE" })
